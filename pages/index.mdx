...
{<h1 className={clsx(styles.headline, "hidden md:block text-center")}>The Erlang Programming Language</h1>}
...
<p className="mt-6 text-center tracking-tight mb-2 text-lg text-gray-600 dark:text-gray-500 md:!text-2xl">Practical functional programming for a parallel world</p>
