...
{<h1 className={clsx(styles.headline, "hidden md:block xtext-center")}>The Erlang Programming Language</h1>}
...
<p className="mt-6 xtext-center tracking-tight mb-2 text-lg text-gray-600 dark:text-gray-500 md:!text-2xl">Practical functional programming for a parallel world</p>
...
<div className='flex xjustify-center mt-4'>
        <Link className={styles.cta} href="/downloads">
          Download Erlang/OTP <span>→</span>
        </Link>
</div>
