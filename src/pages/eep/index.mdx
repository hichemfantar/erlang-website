...
To document the various proposals and the decisions taken we use the Erlang Enhancement Process inspired by the Python Enhancement Process. [EEP 0](/eeps/eep-0077) contains a listing of all submitted EEPs.
...
Before submitting an EEP; read [EEP 1 - EEP Purpose and Guidelines](/eep/eeps/eep-0001) that thoroughly explains the purpose of EEPs, their life cycle, and prescribed format. The EEP editor will reject EEPs that do not follow the guidelines. Also check the list of existing [EEPs](/eeps) before reinventing something.

{/* [EEP 1 - EEP Purpose and Guidelines](_eeps/eep-0001.md) */}
